...
var EnlighterJS = (function (e) {
    ...
    var c = {
        ...
        complex: { regex: /[\b\W](?:-?(?:(?:\d+\.\d+|\.\d+|\d+\.|\d+)(?:e[+-]?\d+)?)|\d+(?:e[+-]?\d+))[ij]/gi, type: "n5" },
    ...
    function Z(e, t, r) {
                            ...
                            if (0 != n[0].length) {
                                ...
                                if (1 < n.length)
                                    for (var l, g, u, p = 0, c = 1; c < n.length; c++)
                                        n[c] &&
                                            ((l = Array.isArray(t.type) && t.type.length >= c ? t.type[c - 1] : a),
                                            (g = Array.isArray(t.filter) && t.filter.length >= c ? t.filter[c - 1] : o),
                                            (u = n[0].indexOf(n[c], p)),
        ...
        for (var l = [], g = 0, u = 0; u < i.length; u++) {
            if ((g < i[u].index && l.push(b(e.substring(g, i[u].index), n, null, g)), i[u].filter)) for (var p = i[u].filter(i[u]) || [], c = 0; c < p.length; c++) l.push(p[c]);
            else l.push(i[u]);
                ...
                n(e, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                c.blockComments,
                                c.brackets,
                                { regex: /\b(true|false|null|nil|if|then|else|for|while|do|class|implements|extends|function|end|void|return|in|of|new|this|try|catch|def|except)\b/gi, type: "k1" },
                                c.mCalls,
                                c.fCalls,
                                c.octal,
                                c.bin,
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    c.prop,
                                    { regex: /#.*$/gm, type: "k4" },
                                    { regex: /\b(break|case|catch|continue|do|else|for|if|goto|switch|try|throw|while)\b/g, type: "k1" },
                                    { regex: /\b(__[A-Z][A-Z0-9_]+__|__cplusplus)\b/g, type: "e3" },
                                    { regex: /\b(\w+\d+?_t)\b/g, type: "k5" },
                                    { regex: /\b(bool|char|double|float|int|long|short|void)\b/g, type: "k5" },
                                    { regex: /\b(enum|struct|typedef|union)\b/g, type: "k2" },
                                    { regex: /\b(const|volatile|unsigned|signed|restrict)\b/g, type: "k8" },
                                    {
                                    ...
                                    { regex: /\b(new|delete|cast|const_cast|dynamic_cast|static_cast|reinterpret_cast|sizeof|and|bitand|and_eq|not|not_eq|or|bitor|or_eq|xor|xor_eq|compl)\b/g, type: "k3" },
                                    c.mCalls,
                                    c.fCalls,
                                    c.slashComments,
                                    c.blockComments,
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    c.boolean,
                                    c.prop,
                                    { regex: /\b(bool|byte|char|decimal|double|float|int|long|sbyte|short|uint|ulong|ushort|void|string)\b/g, type: "k5" },
                                    { regex: /\b(while|try|throw|switch|if|goto|foreach|for|finally|else|do|continue|catch|case|break)\b/g, type: "k1" },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                ...
                                this.rules = [
                                    ...
                                    c.dqStrings,
                                    c.sqStrings,
                                    { regex: /\W@(charset|import|namespace|page|font-face|keyframes|viewport|document|supports)\b/gi, type: "k4" },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /[^;]\s*(from\s+)([\w.]+)(\s+import)/gi, type: ["k0", "k10", "k0"] },
                                    { regex: /\b(raise|while|try|if|for|finally|else|elif|continue|break)\b/g, type: "k1" },
                                    { regex: /\b(yield|with|return|pass|lambda|is|in|import|global|from|except|def|class|assert|as|async|await)\b/g, type: "k0" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.rules = [
                                { regex: /\b(bool|char|double|float|int|long|short|void)\b/g, type: "k5" },
                                { regex: /\b(enum|struct|typedef|union|object)\b/g, type: "k2" },
                                { regex: /\b(const|volatile|unsigned|signed|restrict)\b/g, type: "k8" },
                                { regex: /\b(readonly|extern|namespace|public|privat|include|cimport|pyximport|cythonize|cdef|cpdef|ctypedef|property|IF|ELIF|ELSE|DEF)\b/g, type: "k0" },
                            ].concat(this.rules);
                        },
                    },
                ]),
                ...
                n(t, [
                    {
                        key: "setupLanguage",
                        value: function () {
                            this.rules = [c.poundComments, c.brackets, { regex: /\[(\w+)\]/gm, type: "k9" }, { regex: /\{([\w_-]+)\s*(?::\s*(.*?))?}/gm, type: ["k7", "s0"] }];
                        },
                    },
                ]),
                t
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.rules = [
                                ...
                                { regex: /\b(bool|int|num|double|String|Number|Map|List|Set|Symbol|Boolean|void|Object)\b/g, type: "k5" },
                                { regex: /\b(break|case|catch|continue|do|else|finally|for|if|switch|try|while|throw|rethrow)\b/g, type: "k1" },
                                {
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    c.dqStrings,
                                    { regex: /\$\{\w+\}/gi, type: "k7" },
                                    { regex: /ARG\s+(\w+)(?:(=)(.*?)$)?/gim, type: ["k7", "k3", "s0"] },
                                    { regex: /ENV\s+(\w+)(?:(\s+|=)(.*?)$)?/gim, type: ["k7", "k3", "s0"] },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /\b(case|break|default|else|goto|switch|if|continue|for)\b/g, type: "k1" },
                                    { regex: /\b(func|interface|select|defer|go|map|chan|package|fallthrough|range|import|return)\b/g, type: "k0" },
                                    { regex: /\b(iota)\b/g, type: "k9" },
                                    { regex: /\b(bool|string|u?int(8|16|32|64)?|uintptr|byte|rune|float32|float64|complex64|complex128)\b/g, type: "k5" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /(\/(?:[^/\\]|\\.)*\/)/g, type: "s5" },
                                c.prop,
                                { regex: /\b(byte|char|short|int|long|float|double|String)\b/g, type: "k5" },
                                { regex: /\b(break|case|catch|continue|default|do|else|finally|for|goto|if|switch|throw|try|while)\b/g, type: "k1" },
                                { regex: /^(package|import)(\s+[\w.]+)/gm, type: ["k0", "k10"] },
                                { regex: /\b(const|enum|def)\b/g, type: "k2" },
                                { regex: /\b(as|assert|class|extends|goto|implements|in|interface|return|thows|trait)\b/g, type: "k0" },
                                { regex: /\b(this|super)\b/g, type: "k9" },
                                ...
                                { regex: /[\b\W](-?0x[A-F0-9][A-F0-9_]+[GLIDF]?)\b/gi, type: "n2" },
                                { regex: /[\b\W](-?0b[01][01_]+[GLIDF]?)\b/gi, type: "n3" },
                                { regex: /(-?((?:\d+\.\d+|\.\d+|\d+\.)(?:e[+-]?\d+)?)|\d+(?:e[+-]?\d+)?)/gi, type: "n0" },
                                c.brackets,
                            ];
                        },
                    },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /^(\s*?[a-z0-9._-]+\s*?)(=)/gim, type: ["k2", "k3"] },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /@[\W\w_][\w]+/gm, type: "k11" },
                                c.prop,
                                { regex: /\b(boolean|byte|char|short|int|long|float|double|String|void|Integer|Double|BigInt|Float|Boolean|Byte|Char|Long)\b/g, type: "k5" },
                                { regex: /\b(while|try|catch|case|else|throw|break|if|do|goto|switch|for|continue)\b/g, type: "k1" },
                                { regex: /^(package|import)(\s+[\w.]+)/gm, type: ["k0", "k10"] },
                                { regex: /\b(enum)\b/g, type: "k2" },
                                { regex: /\b(const)\b/g, type: "k8" },
                                { regex: /\b(native|volatile|strictfp|finally|class|static|interface|final|extends|transient|return|throws|public|protected|implements|private|synchronized|default|assert|abstract)\b/g, type: "k0" },
                                { regex: /\b(this|super)\b/g, type: "k9" },
                                { regex: /\b(instanceof|new)\b/g, type: "k3" },
                                c.fCalls,
                                c.mCalls,
                    ...
                    [
                        {
                            ...
                            value: function () {
                                ...
                                this.rules = [
                                    ...
                                    { regex: /\b(break|case|catch|continue|do|else|finally|for|if|switch|try|while|throw)\b/g, type: "k1" },
                                    { regex: /\b(as|async|class|constructor|debugger|default|export|extends|function|import|return|with|yield|implements|package|protected|static|interface|private|public|await|module)\b/g, type: "k0" },
                                    { regex: /\b(this|super)\b/g, type: "k9" },
                                    { regex: /\b(instanceof|new|delete|typeof|void|in)\b/g, type: "k3" },
                                    { regex: /\W(=>)\W/g, type: "k3" },
                                    c.slashComments,
                                    c.blockComments,
                                    { regex: /\W(\/(?:[^/\\\n]|\\.)*\/\w*)/g, type: "e2" },
                ...
                n(t, [
                    {
                        key: "setupLanguage",
                        value: function () {
                            this.rules = [{ regex: /"(?:[^"\\]|\\.)*"\s*:/g, type: "k2" }, c.dqStrings, c.boolean, c.null, { regex: /\{|}|\(|\)|\[|]/g, type: "g1" }, c.int, c.floats, { regex: /,|:/g, type: "g0" }];
                        },
                    },
                ]),
                t
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.rules = this.rules.concat([
                                { regex: /(<)([A-Z:_][A-Z0-9:.-]*)([\s\S]*?)(\/?>)/gi, type: ["g1", "x1", "text", "g1"], filter: [null, null, null, null] },
                                { regex: /(<\/)([A-Z:_][A-Z0-9:.-]*\s*)(>)/gi, type: ["g1", "x1", "g1"] },
                            ]);
                        },
                    },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.rules = [
                                ...
                                c.char,
                                c.prop,
                                { regex: /\b(Double|Float|Long|Int|Short|Byte|Any|String|Array)\b/g, type: "k5" },
                                { regex: /\b(break|continue|do|else|for|if|throw|try|when|while|catch|finally)\b/g, type: "k1" },
                                { regex: /^(package|import)(\s+[\w.]+)/gm, type: ["k0", "k10"] },
                                { regex: /\b(enum|typealias|object|companion|val|var)\b/g, type: "k2" },
                                {
                                ...
                                { regex: /\b(as|class|fun|in|interface|is|return|by|constructor|delegate|dynamic|field|file|get|init|param|property|receiver|set|setparam|where|field|it)\b/g, type: "k0" },
                                { regex: /\b(this|super)\b/g, type: "k9" },
                                { regex: /\b(instanceof|new)\b/g, type: "k3" },
                    ...
                    [
                        {
                            key: "setupLanguage",
                            value: function () {
                                this.rules = [{ regex: /(?:^|[^\\])%.*$/gm, type: "c0" }, { regex: /(?:^|[^\\])(\\\w+)(?:[\W\s])/gm, type: "k0" }, { regex: /[$()]/g, type: ["s3"] }, c.int, c.floats, c.brackets];
                            },
                        },
                    ],
                    [
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /\b(break|do|else|elseif|end|for|if|repeat|then|until|while)\b/g, type: "k1" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                c.null,
                                c.sqStrings,
                                { regex: /\b(NOT NULL|UNIQUE|PRIMARY KEY|FOREIGN KEY|CHECK|DEFAULT|INDEX)\b/gi, type: "k4" },
                                { regex: /`\S+?`(?:\.`\S+?`)*/g, type: "k9" },
                                { regex: /\b(all|and|any|between|exists|in|like|not|or|is null|is not null|=|!=|<>|>|<|>=|<=|!<|!>)\b/gi, type: "k3" },
                                { regex: /\b(SELECT|INSERT|UPDATE|DELETE|INTO|FROM|CREATE|TABLE|VIEW|WHERE|TRIGGER|ALTER|ORDER BY|DESC|ASC|AS|BETWEEN|JOIN|LEFT|RIGHT|INNER|OUTER|USING|ON|UNION)\b/gi, type: "k0" },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                l(s(t.prototype), "setupLanguage", this).call(this),
                                    (this.rules = this.rules.concat([
                                        c.poundComments,
                                        { regex: /\b(tinyint|smallint|mediumint|bigint|int|integer|boolean|decimal|number|float|double|bit|double precision|real|dec|numeric|fixed)\b/g, type: "k5" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                c.mCalls,
                                c.prop,
                                { regex: /\b(break|case|catch|continue|do|else|elseif|end|end_try_catch|endfor|endif|endmethods|endparfor|endproperties|endswitch|endwhile|for|if|switch|try|until|while)\b/gi, type: "k1" },
                                {
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                c.sqStrings,
                                c.bqStrings,
                                { regex: /^\s*(Var(\s+\\GLOBAL)?)(\s+\w+)\b/g, type: ["k2", "k7"] },
                                ...
                                { regex: /\b(admin|all|auto|both|colored|false|force|hide|highest|lastused|leave|listonly|none|normal|notset|off|on|open|print|show|silent|silentlog|smooth|textonly|true|user)\b/gi, type: "k9" },
                                c.blockComments,
                                { regex: /[#;].*?$/gm, type: "c0" },
                                c.int,
                                c.hex,
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /\b(as|break|case|catch|do|else|elseif|enddeclare|endfor|endforeach|endif|endswitch|endwhile|finally|for|foreach|goto|if|switch|throw|try|while)\b/g, type: "k1" },
                                ...
                                { regex: /\b(int|float|bool|string|resource|object|mixed|numeric)\b/g, type: "k5" },
                                c.slashComments,
                                c.poundComments,
                                c.blockComments,
                                { regex: /\$[^\s=;()'">:-]+/gim, type: "k7" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.rules = [
                                ...
                                { regex: /@'[\S\s]*?\n\s*'@/g, type: "s5" },
                                { regex: /\b(Begin|Break|Catch|Continue|Else|Elseif|End|Finally|For|ForEach|If|Switch|Throw|Try|Until|While)\b/gi, type: "k1" },
                                { regex: /\b(Data|Do|DynamicParam|Exit|Filter|From|Function|In|InlineScript|Hidden|Parallel|Param|Process|Return|Sequence|Trap|Workflow)\b/gi, type: "k0" },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /#\w+/gim, type: "g0" },
                                    { regex: /[@?]\w+/gim, type: "g1" },
                                    { regex: /(IncludeFile|XIncludeFile|IncludeBinary|IncludePath) (.*?)$/gim, type: "k0" },
                                    { regex: /\b(Break|Case|Continue|Default|Else|ElseIf|End|EndIf|EndSelect|For|ForEver|ForEach|Gosub|Goto|If|Next|Repeat|Return|FakeReturn|Select|Until|Wend|While|To|Step)\b/gi, type: "k1" },
                                    {
                                    ...
                                    { regex: /\b(ReDim|Dim|NewList|NewMap|Enumeration|EndEnumeration|Interface|Extends|EndInterface|Structure(?:Union)?|EndStructure(?:Union)?)\b/gi, type: "k4" },
                                    { regex: /\b(?:ReDim|Dim|NewList|NewMap)\s*([\w]+)\(/gim, type: "text" },
                                    { regex: /\b(Define|Global|Protected|Shared|Static|Threaded)\b/gi, type: "k3" },
                                    { regex: /[\w\])]\.(s{\d+}|(?:p-ascii|p-utf8|p-bstr|p-unicode|p-variant)|\w+)(?:\([\d,]*\))?/gi, type: "k4" },
                                    {
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /\b(bool|char|double|float|int|long|short|void|string)\b/g, type: "k5" },
                                c.mCalls,
                                c.null,
                                c.boolean,
                                c.slashComments,
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /\b(add|set|print|enable|disable|export|find|get|move|remove)\b/gi, type: "k9" },
                                    { regex: /[^\b](:[a-z-]+)\s/gm, type: "k0" },
                                    { regex: /\$[\w]*/gi, type: "k7" },
                                    { regex: /(?:[a-f0-9]{2}:){5}(?:[a-f0-9]{2})/gi, type: "s0" },
                                    { regex: /(?:\d{1,3}\.){3}(?:\d{1,3})(?:\/\d{1,2})?/gi, type: "s0" },
                                    c.poundComments,
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.rules = [
                                ...
                                { regex: /\b(begin|break|case|do|else|elsif|end|ensure|for|if|in|next|redo|rescue|retry|then|unless|until|when|while)\b/gi, type: "k1" },
                                { regex: /\b((?:__)?[A-Z][A-Z0-9_]+)\b/g, type: "e3" },
                                { regex: /\b(alias|class|defined\?|undef|def|module|return|self|super|yield)\W/gi, type: "k0" },
                                { regex: /\b(and|not|or)\b/gi, type: "k3" },
                                c.poundComments,
                                { regex: /^=begin[\S\s]*?^=end/gim, type: "c2" },
                                { regex: /(%[iqrswx](\W)(?:[^\2\n\\]|\\.)*\2[iomx]*)/gim, type: "s2", filter: e },
                                { regex: /(%[iqrswx]?(\{(?:[^}\\]|\\.)*}|\[(?:[^}\\]|\\.)*]|\((?:[^)\\]|\\.)*\))[iomx]*)/gim, type: "s2", filter: e },
                                { regex: /\W(\/(?:[^/\\]|\\.)*\/\w*)\W/g, type: "e2" },
                                { regex: /\W\?(?:\w|\\M|\\C)(?:-\w|-\\M|-\\C)*\b/g, type: "n1" },
                                { regex: /[\b\W](-?\d[\d_]+?)(?!\.)\b/g, type: "n1" },
                                { regex: /[\b\W](-?0x[A-F0-9][A-F0-9_]+)\b/gi, type: "n2" },
                                { regex: /[\b\W](-?0b[01][01_]+)\b/gi, type: "n3" },
                                { regex: /[\b\W](-?[\d_]+(?:\.[\d_]+)?(?:e[+-]?\d+)?[ji]?)\b/gi, type: "n0" },
                                c.brackets,
                            ];
                        },
                    },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                c.boolean,
                                { regex: /\b(while|loop|in|for|if|else|do|continue|break)\b/g, type: "k1" },
                                ...
                                { regex: /\b([0-9_]+\.?[0-9_]+?(e\+[0-9_]+)?)(?:f32|f64)?\b/gim, type: "n0" },
                                { regex: /\b([0-9_]+|0o[0-9_]+|0x[A-F0-9_]+|0b[0-1_]+)(?:u8|i8|u16|i16|u32|i32|u64|i64|isize|usize)?\b/gim, type: "n1" },
                                c.slashComments,
                                c.blockComments,
                                { regex: /(?:^|[^\\])\/\/[/!].*$/gm, type: "c2" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /\b([A-Z]\w*)\b/g, type: "k5" },
                                { regex: /\b(while|try|catch|else|throw|break|if|do|goto|switch|for|match)\b/g, type: "k1" },
                                { regex: /(package|import)(\s+[\w.]+)/gm, type: ["k0", "k10"] },
                                { regex: /[\b\w\s)](_|:|@|#|<-|←|<:|<%|=|=>|⇒|>:)[\b\w\s]/g, type: "k3" },
                                { regex: /\b(abstract|class|case|extends|final|finally|forSome|implicit|lazy|object|override|private|protected|return|sealed|trait|with|yield)\b/g, type: "k0" },
                    ...
                    [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /\b(if|fi|then|elif|else|for|do|done|until|while|break|continue|case|esac|in|eq|ne|gt|lt|ge|le)\b/gi, type: "k1" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /\b(break|case|catch|continue|else|for|foreach|if|switch|while|try|do)\b/g, type: "k1" },
                                { regex: /\b(base|class|clone|constructor|default|extends|false|function|null|resume|return|static|this|throw|true|yield)\b/g, type: "k0" },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            this.rules = [
                                ...
                                { regex: /\b(nil)\b/gi, type: "e1" },
                                { regex: /\b(break|case|continue|default|do|else|for|if|switch|while|catch|throw|try)\b/g, type: "k1" },
                                { regex: /\b(var|let|enum|struct)\b/g, type: "k2" },
                                { regex: /\b(Int|UInt|Float|Double|Bool|String|Character|Optional|Array|Dictionary)\b/g, type: "k5" },
                                {
                                ...
                                { regex: /(-?(?:[\d_]+\.[\d_]+(?:e[+-]?[\d_]+)?))/gi, type: "n0" },
                                { regex: /(-?0x(?:[A-F0-9_]+\.[A-F0-9_]+(?:p[+-]?[A-F0-9_]+)?))/gi, type: "n2" },
                                c.brackets,
                            ];
                        },
                    },
                ...
                n(t, [
                    {
                        ...
                        value: function () {
                            l(s(t.prototype), "setupLanguage", this).call(this);
                            this.rules = [
                                { regex: /\b(boolean|number|string|any|void|undefined|never|symbol)\b/g, type: "k5" },
                    ...
                    n(t, [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /('.')/g, type: "s0" },
                                    c.brackets,
                                    { regex: /\b(alias|array|variable|downto|range|to|type|units)\b/g, type: "k2" },
                                    { regex: /\b(array|buffer|bus|file)\b/g, type: "k5" },
                                    { regex: /\b(if|else|elsif|end|for|while|loop|when|begin|block|case|exit|next|then)\b/g, type: "k1" },
                                    {
                                    ...
                                    { regex: /\b(abs|not|mod|rem|sll|srl|sla|sra|rol|ror|and|or|nand|nor|xor|xnor|new)\b/g, type: "k3" },
                                    c.floats,
                                ];
                            },
                        },
                        ...
                        [
                            {
                                ...
                                value: function () {
                                    this.rules = [
                                        ...
                                        c.prop,
                                        { regex: /(#.*?)(?:'|$)/gim, type: "k4" },
                                        { regex: /\b(Case|Catch|Continue|Each|Else|ElseIf|End|EndIf|Do|Finally|For|If|Loop|Next|OrElse|Then|Throw|Try|When|While)\b/g, type: "k1" },
                                        ...
                                        { regex: /\b(And|AndAlso|Is|IsNot|Mod|New|Not|Or|TypeOf|Xor)\b/g, type: "k3" },
                                        c.mCalls,
                                        c.fCalls,
                                        { regex: /'.*$/gm, type: "c0" },
                                        c.int,
                        ...
                        [
                            {
                                ...
                                value: function () {
                                    this.rules = [
                                        ...
                                        { regex: /<!--[\s\S]*?-->/g, type: "c1" },
                                        { regex: /(<!\[CDATA\[)([\s\S]*?)(]]>)/gim, type: ["c9", "text", "c9"] },
                                        {
                                            regex: /(<)([A-Z:_][A-Z0-9:.-]*)([\s\S]*?)(\/?>)/gi,
                                            type: ["g1", "x1", "text", "g1"],
                                            filter: [
                    ...
                    n(t, [
                        {
                            ...
                            value: function () {
                                this.rules = [
                                    ...
                                    { regex: /`\w*\b/g, type: "k4" },
                                    { regex: /\[( *\d+(?: *\: *\d+) *)\]/g, type: "e3" },
                                    { regex: /\b(for|generate|if|else|repeat|case|endcase|begin|end|ifnone)\b/g, type: "k1" },
                                    { regex: /\b(output|input|inout|reg|wire|assign)\b/g, type: "k5" },
                                    { regex: /\b(module|endmodule|always|function|endfunction)\b/g, type: "k2" },
                                    {
    ...
    function Ve(e) {
        var t = e.tokens,
            ...
            t =
                ...
                []);
        return (
            0 < e.lineoffset && t.push("counter-reset: enlighter " + (parseInt(e.lineoffset) - 1)),
            L(
                "div",
    ...
    function W(e) {
        var t = ["enlighter-btn"];
        return e.name && t.push("enlighter-btn-" + e.name), L("div", { className: t.join(" "), onClick: e.onClick, title: e.tooltip }, e.text || null);
    }
    function Je() {
    ...
    function Ke(e) {
        ...
        return (
            ...
            (t = L(
                N,
                { className: n },
                L($, { name: "top", layout: r.toolbarTop, toggleClass: i, getRawCode: s }),
                L(Ve, { tokens: e[0].tokens, options: e[0].params }),
                L(Xe, null, e[0].code),
                L($, { name: "bottom", layout: r.toolbarBottom, toggleClass: i, getRawCode: s })
            )),
            r.rawcodeDbclick &&
    ...
    var tt = Object.freeze({
        ...
        inline: function (e) {
            ...
            return 0 < t.cssClasses.length && r.push.apply(r, g(t.cssClasses)), L(N, { className: r }, L(Qe, { tokens: e[0].tokens, options: t }));
        },
        codegroup: function (e) {
            ...
            return (
                ...
                (t = e.map(function (e) {
                    return L("div", { style: "display:none" }, L(Ve, { tokens: e.tokens, options: e.params }), L(Xe, null, e.code));
                })),
                l(0),
                (r = L(
                    N,
                    ...
                    L(N, { name: "codegroup-wrapper" }, L($, { name: "top", layout: n.toolbarTop, toggleClass: a, getRawCode: o }), t, L($, { name: "bottom", layout: n.toolbarBottom, toggleClass: a, getRawCode: o }))
                )),
                n.rawcodeDbclick &&
        ...
        return (
            ...
            (tt[t] || Ke)(
                e.map(function (e) {
                    ...
                    return (t = e.language), (r = u.language || null), (t = je(t) || je(r) || "generic"), v[t] || (v[t] = new k[t]()), { tokens: v[t].analyze(n), params: e, code: n };
                })
            )
        );
    }
